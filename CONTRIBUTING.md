...
`cloud-itonami-isco-8113` accepts contributions to the OSS actor, policy tests,
...
- Keep production writes behind DrillCoordGovernor.
- Never add an op to the allowlist that could authorize drilling to
  proceed, finalize a drilling-operation-execution decision, or
  override a drilling supervisor's or site-safety-officer's judgment
